                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="sss_contribution" id="sss_contribution"
                               ...
                               value="<?= esc(old('sss_contribution', $employee['sss_contribution'] ?? '0.00')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="philhealth_contribution" id="philhealth_contribution"
                               class="form-control contrib-emp" step="0.01" min="0"
                               value="<?= esc(old('philhealth_contribution', $employee['philhealth_contribution'] ?? '0.00')) ?>"
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="pagibig_contribution" id="pagibig_contribution"
                               class="form-control contrib-emp" step="0.01" min="0"
                               value="<?= esc(old('pagibig_contribution', $employee['pagibig_contribution'] ?? '0.00')) ?>"
